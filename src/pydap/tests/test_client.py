...
@pytest.mark.client
def test_open_dap4_url(sequence_app):
    """Open a DAP4 URL and check dataset keys."""
    dataset = open_url('http://test.opendap.org:8080/opendap/data/nc/coads_climatology2.nc', sequence_app)
